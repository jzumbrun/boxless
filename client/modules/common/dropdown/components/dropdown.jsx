  ...
  render () {
    return (
      <div id={this.props.id} className={this.props.className ? ('dropdown ' + this.props.className) : 'dropdown'}>
        <div>
          <a href='javascript:void(0)' id={this.id} className={this.props.trigger.className || 'dropdown-toggle'} onClick={this.handleClick.bind(this)}>{this.props.trigger.label} {this.props.caret && <span className='caret' />}</a>
          {this.state.show &&
